...
class Jeu{
  ...
  public :
    Jeu(Plateau plateau, std::vector<Joueur> listeJoueur); //Constructeur
    Jeu(Plateau plateau, std::vector<Joueur> listeJoueur, bool finPartie);  //Constructeur pour simuler une fin de partie
    ~Jeu(); //Destructeur
